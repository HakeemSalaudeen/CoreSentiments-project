...
with DAG(
    ...
    download_zipped_files = PythonOperator(
        ...
        op_kwargs={
            ...
            'save_path': '/home/hakeem_bluechip/airflow/my_env/dags/CoreSentiments/LandingPath2.gz'
        } 
    )
    ...
    extract_zip_files = BashOperator(
        ...
        bash_command = 'gunzip /home/hakeem_bluechip/airflow/my_env/dags/CoreSentiments/LandingPath2.gz' 
    )
    ...
    # extract_zip_files = BashOperator(
    # task_id='extract_zip_files',
    # bash_command='unzip -o /home/hakeem_bluechip/airflow/my_env/dags/CoreSentiments/LandingPath2.zip -d /home/hakeem_bluechip/airflow/my_env/dags/CoreSentiments/Extracted_files'
    # )
    
    # # Step 5: Task to extract the zip file
    # extract_zip_files = BashOperator(
    #     task_id='extract_zip_files',
    #     bash_command='unzip /home/hakeem_bluechip/airflow/my_env/dags/CoreSentiments/LandingPath2.zip -d /home/hakeem_bluechip/airflow/my_env/dags/CoreSentiments/'
    # )
