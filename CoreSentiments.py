...
with DAG(
    ...
    download_zipped_files = PythonOperator(
        ...
        op_kwargs={
            ...
            'save_path': '/home/**/airflow/my_env/dags/CoreSentiments/LandingPath3.gz'
        } 
    )
    ...
    extract_zip_files = BashOperator(
        ...
        bash_command = 'gunzip /home/**/airflow/my_env/dags/CoreSentiments/LandingPath3.gz' 
    )
    ...
    fetchPageviews = PythonOperator(
        ...
        op_kwargs={
            'file_path' : '/home/**/airflow/my_env/dags/CoreSentiments/LandingPath3',
